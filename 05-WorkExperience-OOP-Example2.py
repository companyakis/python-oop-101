...
# Part 2: We can update object attributes!
...
# We can update object attributes!

department_it_bilge.start_year = 2005

department_it_bilge.calculate_work_experience() # Employee Bilge has 19 years of work experience.
